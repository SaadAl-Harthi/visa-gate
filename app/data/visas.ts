...
export const turkeyNonSaudiVisaPage: VisaPageData = {
  ...
  seo: {
    title: "استخراج تأشيرة تركيا لغير السعوديين | رحلتنا للتأشيرات",
    description:
      "خدمة استخراج تأشيرة تركيا لغير السعوديين المقيمين في السعودية مع تجهيز المتطلبات وحجز الموعد.",
    openGraphTitle: "استخراج تأشيرة تركيا لغير السعوديين",
    openGraphDescription:
      "نساعد المقيمين غير السعوديين داخل المملكة في تجهيز ملف تأشيرة تركيا.",
    twitterTitle: "استخراج تأشيرة تركيا لغير السعوديين",
    twitterDescription:
      "خدمة تأشيرة تركيا للمقيمين غير السعوديين داخل السعودية.",
  },
  heroIcon: "🇹🇷",
